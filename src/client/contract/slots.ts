 ...
 */
export type RedteamTriggerProps =
  PropsRuntime<'sidebar.footer.action'> & PropsStore<RedteamStoreHandle> & PropsLocale<'redteam'>
 ...
 */
export type RedteamConsoleProps =
  ComposedProps<'shell.overlay', string, 'redteam.section', RedteamStoreHandle, RedteamConsoleInjected, never, 'redteam'>

/** Section component props: root runtime share, the shared store (dataset + actions), and the dictionary seat. */
export type RedteamSectionProps =
  PropsRuntime<'redteam.section'> & PropsStore<RedteamStoreHandle> & PropsLocale<'redteam'>
