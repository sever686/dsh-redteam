...
export type ActionKey = 'activity.action.scan' | 'activity.action.breach' | 'activity.action.cred' | 'activity.action.recon' | 'activity.action.report';
...
export declare const EMPTY_DATASET: RedteamDataset;
